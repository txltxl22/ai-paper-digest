...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python debug/debug_embedding_recommendations.py <user_id> [model_name]")
        print("Examples:")
        print("  python debug/debug_embedding_recommendations.py yu")
        print("  python debug/debug_embedding_recommendations.py yu all-MiniLM-L6-v2")
        print("  python debug/debug_embedding_recommendations.py yu all-mpnet-base-v2")
        sys.exit(1)
