...
class TestWebSummaryDisplay:
    ...
    def test_index_page_markdown_content_field(self, tmp_path):
        ...
        # Create test data with 'markdown_content' field (new format)
        test_data = {
            "service_data": {
                "arxiv_id": "test.12345",
                "source_type": "system"
            ...
            "summary_data": {
                "markdown_content": "# Test Paper\n\nThis is test content with markdown_content field.",
                "tags": {"top": ["test"], "tags": ["test", "web"]}
            }
        }
    ...
    def test_index_page_content_field_fallback(self, tmp_path):
        """Test that index page correctly falls back to 'content' field."""
        from app.index_page.services import EntryScanner, EntryRenderer
        
        summary_dir = tmp_path / "summary"
        summary_dir.mkdir(parents=True, exist_ok=True)
        
        # Create test data with 'content' field (legacy format)
        test_data = {
            "service_data": {
                "arxiv_id": "test.12345",
                "source_type": "system"
            ...
            "summary_data": {
                "content": "# Legacy Paper\n\nThis is legacy content with content field.",
                "tags": {"top": ["legacy"], "tags": ["legacy", "fallback"]}
            }
        }
    ...
    def test_detail_page_structured_summary_loading(self, tmp_path):
        ...
        structured_data = {
            ...
            "summary_data": {
                ...
                "markdown_content": "# 测试论文\n# Test Paper\n\nTest content for web integration.",
                "tags": {"top": ["test"], "tags": ["test", "web", "integration"]}
            }
        }
        ...
        assert "Test content for web integration" in html_content, "Content should be in HTML"
